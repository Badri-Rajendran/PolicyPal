...
**In progress:** comparison of real purchasable health plans from the CMS Marketplace API. That half is narrower than the Q&A — ACA individual and family plans, in the 30 states on HealthCare.gov. PolicyPal will compare plans, never recommend one. See [docs/plans](docs/plans/) for the phased roadmap.
