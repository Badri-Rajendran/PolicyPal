...
| Phase | Goal | Status |
| --- | --- | --- |
| [0](phase-0-hosted-llm.md) | Swap the local LLM for a hosted one | Not started |
| [1](phase-1-marketplace-api.md) | Marketplace API catalog + plan comparison | Not started |
